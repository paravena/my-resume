...
const ProudOf = () => {
  ...
  return (
    <section className="space-y-3 md:space-y-4">
      <h2 className="text-xl sm:text-h2 text-primary-600 font-semibold">{t('proudOf.title')}</h2>
      <div className="space-y-3 text-body-sm sm:text-body">
        <p className="flex items-start">
          ...
          <span>
            {t('proudOf.degree.text')}{' '}
            <span className="font-bold">
              {t('proudOf.degree.detail')}
            </span>
          </span>
        </p>
        <p className="flex items-start">
          ...
          <span>
            {t('proudOf.openSource.text')}
          </span>
        </p>
        <a
          href={t('proudOf.openSource.url')}
          target="_blank"
